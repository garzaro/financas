...
public class LancamentoServiceImpl implements LancamentoService {
	...
	public void validarLancamento(Lancamento lancamento) {
		/*
		 * informar uma descrição válida, trim remove espaço vazio no inicio e no fim
		...
		/*
		 * Verificar se a data é null e não colocar a data de ontem if
		 * (lancamento.getDataCadastro() == null ||
		 * lancamento.getDataCadastro().isAfter(LocalDate.now())) { throw new
		 * RegraDeNegocioException("Data nula ou vazia. Informe uma data válida."); }
		 */
	}
}
